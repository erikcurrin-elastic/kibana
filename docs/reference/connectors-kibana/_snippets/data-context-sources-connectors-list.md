...
- [Salesforce Jinne](/reference/connectors-kibana/salesforce-jinne-action-type.md): List AI agents, start conversation sessions, send messages, and retrieve transcripts in Salesforce Jinne.
